...
public interface CalcModel {
	...
	/**
	 * Smrzavanje trenutne vrijednosti ako nakon vrijednosti 
	 * unosimo operator kako bi unesena vrijednost ostala 
	 * prikazana na ekranu te zapamćena za daljnje računanje.
	 * @param value
	 */
	void freezeValue(String value);
	
	/**
	 * Provjera postoji li smrznuta vrijednost.
	 * @return
	 */
